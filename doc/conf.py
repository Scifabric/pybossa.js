...
project = u'PyBossa.JS JavaScript library for PyBossa'
...
latex_documents = [
  ('index', 'PyBossa.js.tex', u'PyBossa.JS JavaScript library for PyBossa',
...
man_pages = [
    ('index', 'app-pybossa.js', u'PyBossa.JS JavaScript library for PyBossa',
...
texinfo_documents = [
  ('index', 'pybossa.js', u'PyBossa.JS JavaScript library for PyBossa',
